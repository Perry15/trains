...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.5\textwidth]{immagini/Fogg_behavior_model.pdf}
...
\begin{comment}
È stato fatto uno studio per valutare le attitudini dei giocatori in un ``health game'' multiplayer e sono stati riscontrati $5$ tipi di giocatori:
\begin{description}
    ...
    \item[social experience seekers]: usano i mezzi di comunicazione del gioco e applicano il role-playing generato da essi per interagire con i compagni di gioco;
...
\section{Gamification: caratteristiche del sistema\label{sec:gamification-utenti}}
...
\section{Meccaniche di gioco in Trains\label{sec:meccaniche-app}}
...
\section{Dinamiche di gioco e FBM (Fogg Behavior Model)\label{sec:dinamiche-fbm}}
