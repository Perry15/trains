...
\begin{itemize}
    \item le differenti dimensioni dei dispositivi mobile;%smartphone (perchè non è per tablet)
...
\begin{figure}[htp]
    ...
    {\includegraphics[width=.45\textwidth]{immagini/profile.jpg}} \quad
    \subfloat[Schermata iOS Home][Schermata iOS Home]
    {\includegraphics[width=0.45\textwidth]{immagini/profile.jpg}} \quad
